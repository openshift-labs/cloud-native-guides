...
![Maven Build]({% image_path codeready-commands-build.png %}){:width="340px"}
...
~~~shell
$ cd labs/catalog-spring-boot
$ odo create redhat-openjdk18-openshift:1.4 catalog-service --app catalog --binary target/catalog-1.0-SNAPSHOT.jar
 ✓   Checking component
 ✓   Checking component version
 ✓   Creating component catalog-service
 OK  Component 'catalog-service' was created and ports 8080/TCP,8443/TCP,8778/TCP were opened
 OK  Component 'catalog-service' is now set as active
~~~
...
~~~shell
$ odo push
Pushing changes to component: catalog-service
 ✓   Waiting for pod to start
 ✓   Copying files to pod
 ✓   Building component
 OK  Changes successfully pushed to component: catalog-service
~~~
...
Adding URL to component: catalog-service
 OK  URL created for component: catalog-service

catalog-service - http://catalog-service-catalog-{{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}.openshiftworkshop.com
~~~
...
Once successfully built, your new version of the jar will be pushed automatically into the Catalog Component thank to the `odo watch` command. You should see following logs in the Terminal where you ran the `odo watch` command.
...
$ odo url list
NAME        URL                                                              PORT
service     http://catalog-service-catalog-{{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}.apps.openshiftworkshop.com      8080
$ curl http://catalog-service-catalog-{{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}.apps.openshiftworkshop.com/api/catalog
